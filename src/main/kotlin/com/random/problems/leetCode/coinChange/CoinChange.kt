...
fun main() {
    ...
    val input = mapOf(
        intArrayOf(1, 2, 5) to 11,
        intArrayOf(2) to 3,
        intArrayOf(1) to 0,
        intArrayOf(1, 2, 5) to 100,
        intArrayOf(186, 419, 83, 408) to 6249,
        intArrayOf(2, 5, 10, 1) to 27,
        intArrayOf(1, 2147483647) to 2,
        intArrayOf(461, 307, 4, 97, 352, 446, 479, 243) to 7265
    )

    input.forEach{ solutions.runAll(it.toPair()) }

}

fun List<Solution>.runAll(input: Pair<IntArray, Int>) {
